...
CONTEXT
- The pipeline produced 10 candidates of the day and ordered them by ML ranking.
...
- 6-month thesis validity (focus on catalysts and risks material within the next 6 months)
